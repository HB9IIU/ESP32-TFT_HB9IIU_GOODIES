...
def main():
    ...
    ttf_file = str(script_dir / "SFProText-Bold.ttf")
    size_pt = 160
    dpi = 72
    first = 0x20
    last = 0x7E
    ...
    font_name = f"{ttf_stem}{size_pt}pt7b"
    ...
    for code in range(first, last + 1):
        ...
        glyph_entries.append((bitmap_offset, w, h, clamp_int8(x_advance), clamp_int8(x_offset), clamp_int8(y_offset)))
